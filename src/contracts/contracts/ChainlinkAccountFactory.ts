...
export interface ChainlinkAccountFactoryInterface extends Interface {
  getFunction(
...
export interface ChainlinkAccountFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ChainlinkAccountFactory;
  waitForDeployment(): Promise<this>;

  interface: ChainlinkAccountFactoryInterface;
