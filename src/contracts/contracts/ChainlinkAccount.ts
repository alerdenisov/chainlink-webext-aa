...
export interface ChainlinkAccountInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addDeposit"
      | "eip712Domain"
...
export interface ChainlinkAccount extends BaseContract {
  connect(runner?: ContractRunner | null): ChainlinkAccount;
  waitForDeployment(): Promise<this>;

  interface: ChainlinkAccountInterface;
